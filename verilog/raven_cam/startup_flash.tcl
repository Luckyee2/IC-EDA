...
# Fast flash programming (note:  this does not work on the original
# Raven board, probably due to speed restrictions caused by needing
# to bias the Raven device into an unusual power-down state.

proc ftdi::fast_program {datavec cmdword device address } {
